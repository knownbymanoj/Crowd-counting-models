...
class CrowdDataset(Dataset):
    ...
    def __getitem__(self,index):
        ...
        #print(img_name,self.gt_dmap_root)
        ...
        return img_name,img_tensor,gt_dmap_tensor


# test code
if __name__=="__main__":
    root_dir = os.getcwd()
    img_root=os.path.join(root_dir,'ShanghaiTech','part_A','train_data','images')
    gt_dmap_root=os.path.join(root_dir,'ShanghaiTech','part_A','train_data','ground-truth')
